...
class TestGamesRoutes(unittest.TestCase):
    ...
    def test_create_game_success(self) -> None:
        ...
        new_game_data = {
            ...
            "description": "A collaborative adventure through pull requests and code reviews",
            "category_id": 1,
            "publisher_id": 1,
            "star_rating": 4.8
        }
    ...
    def test_create_game_invalid_publisher(self) -> None:
        ...
        invalid_game_data = {
            ...
            "description": "A game with non-existent publisher",
            "category_id": 1,
    ...
    def test_create_game_invalid_category(self) -> None:
        ...
        invalid_game_data = {
            ...
            "description": "A game with non-existent category",
    ...
    def test_create_game_validation_error(self) -> None:
        """Test creation with invalid data that triggers validation"""
        # Arrange - title too short (should trigger validation)
        invalid_game_data = {
            "title": "X",  # Too short
            "description": "A game with invalid title length",
            "category_id": 1,
            "publisher_id": 1
        }
    ...
    def test_update_game_not_found(self) -> None:
        ...
        # Arrange
        update_data = {
            "title": "Updated Non-existent Game"
        }
